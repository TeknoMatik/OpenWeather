 ...
 */
public abstract class BaseJsonHandler<Request extends BaseRequest, Response extends BaseResponse> extends JsonHttpResponseHandler {
    private final static int OK = 200;
    private final static int NOT_FOUND = 404;

    protected List<OnResponseListener<Response>> mResponseListenerList = new ArrayList<OnResponseListener<Response>>();
    ...
    private void onFialure(String responseString, Throwable throwable) {
        Log.e(BaseJsonHandler.class.getName(), MessageFormat.format("Handler [{0}] failed: [{1}]", getUrl(), responseString), throwable);
